    ...
    return (
        <div className='px-5 pb-6 '>
            <div className=' w-[231px] mt-7'>
                <h1 className=' text-[24px] text-left text-[#1D2226] font-medium '>Create your <br /> PopX account </h1>
            ...
            <div className='mb-26 mt-3'>
                ...
                <label className="mr-4 text-sm flex items-center">
                    <input type="radio" name="agency" className="mr-2 size-4" defaultChecked="true" /> Yes
                </label>
            ...
            <Link to="/account">
                <button className='bg-[#6C25FF] w-full text-center text-white p-2 rounded-[6px] mt-16 text-sm cursor-pointer'>Create Account</button>
            </Link>
